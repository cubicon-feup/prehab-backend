...
class UserViewTests(TestSuit):
    ...
    #     self.assertEqual(res.json()['details'], 'Validation Error. Parameter activation_code is a required property')
    #
    ...
    #     self.assertEqual(res.json()['details'], 'Activation code invalid.')
    #
    #     # SUCCESS
    #     body = {
    #         "activation_code": "12345",
