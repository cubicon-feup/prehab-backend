# Generated by Django 2.0.2 on 2018-04-21 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finished_date', models.DateField(db_column='finished_date', default=None, null=True)),
                ('was_difficult', models.BooleanField(default=False)),
                ('patient_notes', models.CharField(default='', max_length=256, null=True)),
                ('seen_by_doctor', models.BooleanField(default=False)),
                ('doctor_notes', models.CharField(default='', max_length=256, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ('user', models.OneToOneField(db_column='id', on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ForeignKey(db_column='role_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='role', to='prehab_app.Role'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='prehab',
            field=models.ForeignKey(db_column='prehab_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='patient_task_schedule', to='prehab_app.Prehab'),
        ),
        migrations.AddField(
            model_name='patienttaskschedule',
            name='status',
        ...
        migrations.AddField(
            model_name='patienttaskschedule',
            name='task',
            field=models.ForeignKey(db_column='task_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='patient_task', to='prehab_app.Task'),
        ),
        migrations.AddField(
            model_name='prehab',
            name='created_by',
        ...
        migrations.AddField(
            model_name='prehab',
            name='patient',
            field=models.ForeignKey(db_column='patient_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='prehab_patient', to='prehab_app.Patient'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='doctor',
            field=models.ForeignKey(db_column='doctor_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='doctor', to='prehab_app.Doctor'),
        ),
        migrations.AddField(
            model_name='doctorpatient',
            name='patient',
            field=models.ForeignKey(db_column='patient_id', on_delete=django.db.models.deletion.CASCADE,
                                    related_name='patient', to='prehab_app.Patient'),
        ),
    ]
